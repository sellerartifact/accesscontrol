...
var utils = /** @class */ (function () {
     ...
     *  @returns {Boolean}
     */
    utils.hasDefined = function (o, propName) {
     ...
     *  @returns {string[]}
     */
    utils.toStringArray = function (value) {
     ...
     *  @returns {Boolean}
     */
    utils.isFilledStringArray = function (arr) {
     ...
     *  @returns {Array}
     */
    utils.pushUniq = function (arr, item) {
     ...
     */
    utils.uniqConcat = function (arrA, arrB) {
        var arr = arrA.concat();
     ...
     */
    utils.subtractArray = function (arrA, arrB) {
     ...
     *  @param thisArg
     */
    utils.each = function (array, callback, thisArg) {
     ...
     *  @param thisArg
     */
    utils.eachKey = function (object, callback, thisArg) {
        if (thisArg === void 0) { thisArg = null; }
     ...
     *  @returns {Boolean}
     */
    utils.isInfoFulfilled = function (info) {
     ...
     *  is invalid.
     */
    utils.validName = function (name, throwOnInvalid) {
     ...
     *  is invalid.
     */
    utils.hasValidNames = function (list, throwOnInvalid) {
        if (throwOnInvalid === void 0) { throwOnInvalid = true; }
        var allValid = true;
     ...
     *  is invalid.
     */
    utils.validResourceObject = function (o) {
        if (utils.type(o) !== 'object') {
     ...
     *  is invalid.
     */
    utils.validRoleObject = function (grants, roleName) {
     ...
     */
    utils.getInspectedGrants = function (o) {
        var grants = {};
     ...
     *  @returns {string[]}
     */
    utils.getResources = function (grants) {
        // using an object for unique list
        var resources = {};
        utils.eachRoleResource(grants, function (role, resource) {
     ...
     */
    utils.normalizeActionPossession = function (info, asString) {
        ...
        switch (s[0].trim().toLowerCase()) {
            case enums_1.Action.CREATE:
                info.action = enums_1.Action.CREATE;
                break;
            case enums_1.Action.READ:
                info.action = enums_1.Action.READ;
                break;
            case enums_1.Action.UPDATE:
                info.action = enums_1.Action.UPDATE;
                break;
            case enums_1.Action.DELETE:
                info.action = enums_1.Action.DELETE;
                break;
            default:
                throw new core_1.AccessControlError("Invalid action: " + s[0]);
        }
        // validate and normalize possession
        if (info.possession || s[1]) {
            switch ((info.possession || s[1]).trim().toLowerCase()) {
                case enums_1.Possession.OWN:
                    info.possession = enums_1.Possession.OWN;
                    break;
                case enums_1.Possession.ANY:
                    info.possession = enums_1.Possession.ANY;
                    break;
                default:
                    throw new core_1.AccessControlError("Invalid action possession: " + (info.possession || s[1]));
            }
        }
        else {
     ...
     */
    utils.normalizeQueryInfo = function (query) {
     ...
     *  @throws {AccessControlError} - If invalid role/resource found.
     */
    utils.normalizeAccessInfo = function (access, all) {
     ...
     *  @returns {IAccessInfo}
     */
    utils.resetAttributes = function (access) {
        if (access.denied) {
            access.attributes = [];
            return access;
        }
     ...
     *  @returns {string[]}
     */
    utils.getRoleHierarchyOf = function (grants, roleName, rootRole) {
     ...
     */
    utils.getFlatRoles = function (grants, roles) {
     ...
     *  all exist.
     */
    utils.getNonExistentRoles = function (grants, roles) {
        var non = [];
     ...
     *  if none.
     */
    utils.getCrossExtendingRole = function (grants, roleName, extenderRoles) {
     ...
     */
    utils.extendRole = function (grants, roles, extenderRoles) {
     ...
     */
    utils.preCreateRoles = function (grants, roles) {
     ...
     */
    utils.commitToGrants = function (grants, access, normalizeAll) {
     ...
     */
    utils.getUnionAttrsOfRoles = function (grants, query) {
     ...
     */
    utils.filter = function (object, attributes) {
     ...
     */
    utils.filterAll = function (arrOrObj, attributes) {
